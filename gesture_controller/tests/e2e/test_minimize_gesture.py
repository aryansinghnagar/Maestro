...
def test_minimize_gesture_e2e() -> None:
    ...
    with patch("gesture_controller.core.engine.start_camera_process"), \
        ...
        with patch("gesture_controller.core.engine.compute_features", side_effect=mock_compute_features):
