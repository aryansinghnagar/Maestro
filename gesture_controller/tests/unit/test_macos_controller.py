...
def test_macos_minimize_active_window(mock_system: MagicMock) -> None:
    ...
    mock_appservices.AXUIElementCopyAttributeValue.side_effect = [
        (0, mock_window),
        (0, mock_btn)
    ]
...
def test_macos_mouse_move(mock_system: MagicMock) -> None:
    ...
    mock_quartz.CGEventCreateMouseEvent.assert_called_with(None, mock_quartz.kCGEventMouseMoved, mock_quartz.CGPoint(300, 400), 0)
    ...
    mock_quartz.CGEventCreateMouseEvent.assert_called_with(None, mock_quartz.kCGEventMouseMoved, mock_quartz.CGPoint(150, 150), 0)
...
def test_macos_media_controls(mock_system: MagicMock) -> None:
    ...
    mock_appkit.NSEvent.otherEventWithType_location_modifierFlags_timestamp_windowNumber_context_subtype_data1_data2_.return_value = MagicMock()
    ...
    assert mock_appkit.NSEvent.otherEventWithType_location_modifierFlags_timestamp_windowNumber_context_subtype_data1_data2_.call_count == 10
