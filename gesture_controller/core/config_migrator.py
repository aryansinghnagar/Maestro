...
def register_migration(from_version: str, to_version: str) -> Callable[[Callable[[dict[str, Any]], dict[str, Any]]], Callable[[dict[str, Any]], dict[str, Any]]]:
...
def migrate_config(config: dict[str, Any], target_version: str = "2.0") -> dict[str, Any]:
    ...
    while current_version != target_version and steps < 100:
        ...
        try:
            ...
            logger.exception("Migration step failed", from_version=current_version, to_version=next_version, error=str(e))
