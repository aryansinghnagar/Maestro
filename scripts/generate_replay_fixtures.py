...
def generate_fixtures():
    ...
    pointing_coords = [
        (0.5, 0.8, 0.0),   # 0: WRIST
        (0.45, 0.65, -0.02), (0.47, 0.7, -0.01), (0.48, 0.73, -0.01), (0.47, 0.7, -0.01),
        (0.44, 0.6, 0.0), (0.43, 0.45, 0.0), (0.42, 0.33, 0.0), (0.41, 0.22, 0.0), # Index extended
        (0.5, 0.62, 0.0), (0.51, 0.68, 0.0), (0.51, 0.72, 0.0), (0.50, 0.7, 0.0),
        (0.55, 0.63, 0.0), (0.56, 0.68, 0.0), (0.56, 0.72, 0.0), (0.55, 0.7, 0.0),
        (0.59, 0.64, 0.0), (0.60, 0.68, 0.0), (0.60, 0.71, 0.0), (0.59, 0.69, 0.0),
    ]
    for i in range(20):
